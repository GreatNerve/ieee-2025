              ...
              <li key={tab.label} className="relative">
                ...
                >
                  <Link
                    href={tab.href}
                    className={cn(
                      "group relative inline-block text-[rgb(207,206,206)] text-[19px] px-2 py-1 transition-colors duration-200",
        ...
        <div className="flex items-center gap-3 z-10 shrink-0">
          <Button
            className={cn(
              ...
              "hover:border-[#00bfff] hover:shadow-[inset_0_0_0_2px_#2c3e50,_0_0_12px_#00bfff,_0_0_4px_#2c3e50] hover:scale-110",
          ...
          <div
            className={cn(
              "md:hidden flex flex-col gap-1.5 cursor-pointer p-2 border border-[#3aadfb] rounded-lg bg-[#3aadfb] shadow",
                ...
                {tabs.map((tab, idx) => (
                  ...
                  >
                    <Link
                      href={tab.href}
                      className={cn(
                        "group relative inline-block text-white text-base py-1 transition-colors duration-200",
                        "hover:text-[#00ffff] focus:text-[#00ffff]"
                      )}
